...
export function ProductPreviewHeaderSkeleton() {
  return (
    <>
      <PanelToolbar>
        <Skeleton className="size-7 rounded-md" />
...
export function ProductPanelContentSkeleton() {
  return (
    <PanelContent>
...
export function ProductDetailViewSkeleton() {
  return (
    <>
      ...
      <ProductPanelContentSkeleton />
    </>
  );
}

export function ProductPreviewViewSkeleton() {
  return (
    <>
      <ProductPreviewHeaderSkeleton />
      <ProductPanelContentSkeleton />
    </>
  );
}
