...
export function ProductVariantPageHeaderSkeleton() {
  return (
    <PanelGroup>
      <PanelHeader>
...
export function ProductVariantPreviewHeaderSkeleton() {
  return (
    <>
      <PanelToolbar>
        <Skeleton className="size-7 rounded-md" />
...
export function ProductVariantPanelContentSkeleton() {
  return (
    <PanelContent>
...
export function ProductVariantDetailViewSkeleton() {
  return (
    <>
      <ProductVariantPageHeaderSkeleton />
      <ProductVariantPanelContentSkeleton />
    </>
  );
}

export function ProductVariantPreviewViewSkeleton() {
  return (
    <>
      <ProductVariantPreviewHeaderSkeleton />
      <ProductVariantPanelContentSkeleton />
    </>
  );
}
