...
export function ScanListingPageHeaderSkeleton() {
  return (
    <PanelGroup>
      <PanelHeader>
...
export function ScanListingPreviewHeaderSkeleton() {
  return (
    <>
      <PanelToolbar>
        <Skeleton className="size-7 rounded-md" />
...
export function ScanListingPanelContentSkeleton() {
  return (
    <PanelContent>
...
export function ScanListingDetailViewSkeleton() {
  return (
    <>
      <ScanListingPageHeaderSkeleton />
      <ScanListingPanelContentSkeleton />
    </>
  );
}

export function ScanListingPreviewViewSkeleton() {
  return (
    <>
      <ScanListingPreviewHeaderSkeleton />
      <ScanListingPanelContentSkeleton />
    </>
  );
}
