...
Output to .plan/[feature-name]/00-overview.md — goal, non-goals, done-when,
files touched, conflicts with other in-flight slugs. Split steps into
01-*.md, 02-*.md as needed.
