...
function Calendar({
  ...
  // Handle readOnly mode by overriding onSelect with a no-op function
  const dayPickerProps = readOnly
    ...
    <Button
      className={cn(
        [
          ...
          "data-[range-end=true]:rounded-(--cell-radius) data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-(--cell-radius) data-[range-end=true]:rounded-r-(--cell-radius) data-[range-start=true]:rounded-l-(--cell-radius)",
          ...
          "data-[range-end=true]:hover:bg-primary! data-[range-start=true]:hover:bg-primary! data-[selected-single=true]:hover:bg-primary!",
          "data-[range-end=true]:hover:text-primary-foreground! data-[range-start=true]:hover:text-primary-foreground! data-[selected-single=true]:hover:text-primary-foreground!",
