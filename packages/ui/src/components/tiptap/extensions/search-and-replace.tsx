/** biome-ignore-all lint/style/useConsistentTypeDefinitions: upstream tiptap-shadcn-master source */
/** biome-ignore-all lint/style/useBlockStatements: upstream tiptap-shadcn-master source */
/** biome-ignore-all lint/suspicious/noExplicitAny: ProseMirror transaction types */
/* eslint-disable */
// @ts-nocheck
